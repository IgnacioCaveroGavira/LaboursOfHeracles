...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=AdventureWorks;User Id=Nacho; Password=iRmtTypYhz13qMH; TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.Property(e => e.OrganizationLevel).HasComment("The depth of the employee in the corporate hierarchy.");
            entity.Property(e => e.Rowguid)
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
                .HasColumnName("rowguid");
        ...
        modelBuilder.Entity<PersonPhone>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("PersonPhone", "Person", tb => tb.HasComment("Telephone number and type of a person."));
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany()
                .HasForeignKey(d => d.BusinessEntityId)
                .OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.PhoneNumberType).WithMany()
        ...
        modelBuilder.Entity<PurchaseOrderHeader>(entity =>
        {
            ...
            entity.Property(e => e.Status).HasComment("Order current status. 1 = Pending; 2 = Approved; 3 = Rejected; 4 = Complete");
        ...
        modelBuilder.Entity<ShoppingCartItem>(entity =>
        {
            ...
            entity.Property(e => e.ProductId)
                ...
                .HasColumnName("ProductID");
            entity.Property(e => e.Quantity).HasComment("Product quantity ordered.");
        ...
        modelBuilder.Entity<WorkOrder>(entity =>
        {
            ...
            entity.Property(e => e.StartDate)
                ...
                .HasColumnType("datetime");
            entity.Property(e => e.StockedQty).HasComment("Quantity built and put in inventory.");
